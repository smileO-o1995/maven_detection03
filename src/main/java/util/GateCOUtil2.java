...
public class GateCOUtil2 {

    List<List<Integer>> verPacket = new ArrayList<>();

    public GateCOUtil2(List<List<Object>> gatePacket) {
    ...
    private void MUX41forCO(List<List<Object>> gatePacket) {
        ...
        for (int i = 1; i < gatePacket.size(); i++) {
            ...
            if (type.contains("IN1")) {
                indexIN1 = i;
            }else if (type.contains("IN2")) {
                indexIN2 = i;
            }else if (type.contains("IN3")) {
                indexIN3 = i;
            }else if (type.contains("IN4")) {
                indexIN4 = i;
            }else if (type.contains("S0")) {
                indexS0 = i;
            }else {
                indexS1 = i;
            }
